...
import { ERC20, TestRECurveBlargitrage, TestRECurveZapper, TestREStablecoins } from "../typechain-types"
...
describe("RECurveZapper", function () {
    ...
    beforeEach(async function () {
        ...
        stablecoins = await factories.REStablecoins.deploy({ token: USDC.address, decimals: 6, hasPermit: true }, { token: USDT.address, decimals: 6, hasPermit: false }, { token: DAI.address, decimals: 18, hasPermit: true })
