...
import { TestBridgeRERC20 } from "../typechain-types"
...
describe("BridgeRERC20", function () {
    let erc20: TestBridgeRERC20
    ...
    beforeEach(async function () {
        ...
        erc20 = await upgrades.deployProxy(factories.BridgeRERC20, { unsafeAllow: ["delegatecall"], kind: "uups" }) as TestBridgeRERC20
    ...
    it("upgrade pattern", async function () {
        const c = await upgrades.deployProxy(factories.BridgeRERC20, { unsafeAllow: ["delegatecall"], kind: "uups" })
        await c.setContractVersion(2e9)
        const c2 = await upgrades.upgradeProxy(c, factories.BridgeRERC20, { unsafeAllow: ["delegatecall"], kind: "uups" })
